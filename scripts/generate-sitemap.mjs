...
const staticPages = [
  ...
  { path: '/services/one-way-taxi', priority: '0.9', changefreq: 'weekly' },
  { path: '/services/round-trip', priority: '0.8', changefreq: 'weekly' },
  { path: '/services/airport-transfer', priority: '0.8', changefreq: 'weekly' },
  { path: '/services/outstation', priority: '0.9', changefreq: 'weekly' },
